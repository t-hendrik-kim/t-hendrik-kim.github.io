...
author: dict = scholarly.search_author_id('D94McnIAAAAJ')
...
shieldio_data_mtl = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['D94McnIAAAAJ:bEWYMUwI8FkC']['num_citations']}",
}
...
shieldio_data_mnemonics = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['D94McnIAAAAJ:k_IJM867U9cC']['num_citations']}",
}
...
shieldio_data_aanets = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['D94McnIAAAAJ:u_35RYKgDlwC']['num_citations']}",
}
...
shieldio_data_e3bm = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['D94McnIAAAAJ:vV6vV6tmYwMC']['num_citations']}",
}
...
shieldio_data_lst = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['D94McnIAAAAJ:TFP_iSt0sucC']['num_citations']}",
}
